...
docker run -p 2222:22 -p 8081:8081 --rm -it ejfdelgado/policiavr:v1.84
...
docker ps
docker stop ea43aecd38af

ssh root@localhost -p 2222

// Se actualiza una nueva versión
docker ps
docker commit -m "file upload" -p 74eeee6bb863  ejfdelgado/policiavr:v1.83
...
docker commit --change='CMD npm run start' 6a078e2fdf0f ejfdelgado/policiavr:v1.84
